const CACHE='vokabeltrainer-v0.9.12-sense-model';
const ASSETS=['./','./index.html','./css/app.css?v=0.9.12','./js/core.js?v=0.9.12','./js/storage.js?v=0.9.12','./js/model.js?v=0.9.12','./js/learning.js?v=0.9.12','./js/translation.js?v=0.9.12','./js/io.js?v=0.9.12','./js/ui.js?v=0.9.12','./js/app.js?v=0.9.12','./manifest.webmanifest','./assets/icons/icon-180.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
