const CACHE='vokabeltrainer-v0.9.13-sense-final';
const ASSETS=['./','./index.html','./css/app.css?v=0.9.13','./js/core.js?v=0.9.13','./js/storage.js?v=0.9.13','./js/model.js?v=0.9.13','./js/learning.js?v=0.9.13','./js/translation.js?v=0.9.13','./js/io.js?v=0.9.13','./js/ui.js?v=0.9.13','./js/app.js?v=0.9.13','./manifest.webmanifest','./assets/icons/icon-180.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
